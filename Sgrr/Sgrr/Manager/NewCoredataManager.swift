        ...
        for entity in fetchResults {
            ...
            if let cakeElementEntities = entity.cakeElements as? Set<CakeElementEntity> {
                for cakeElement in cakeElementEntities {
                    let cakeElement = CakeElement(elementImage: cakeElement.elementImages, elementKeyword: cakeElement.elementKeywords ?? "", cakeDirection: cakeElement.isSide == true ? .side : .top)
